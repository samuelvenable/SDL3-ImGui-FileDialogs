...
#include <apifiledialogs/filedialogs.hpp>    // NGS File Dialogs
#include <apifilesystem/ghc/filesystem.hpp>  // GHC File System
#include <apifilesystem/filesystem.hpp>      // NGS File System
...
namespace {
  void init() {
    ...
    ngs::fs::environment_set_variable("IMGUI_CONFIG_HOME", ngs::fs::environment_get_variable(HOME_PATH));
...
int main() {
  ...
  std::cout << ngs::im::get_open_filename("Portable Network Graphics (*.png)|*.png|" +
